...
circle_shader load_circle_shader(){
  var prog = createShaderFromFiles("circle_blit.vs", "circle_blit.fs");
  return (circle_shader)
    {.prog = prog,
	.offset_loc = glGetUniformLocation(prog, "offset"),
	.radius_loc = glGetUniformLocation(prog, "radius"),
	.color_loc = glGetUniformLocation(prog, "color"),
	.level_loc = glGetUniformLocation(prog, "level")
